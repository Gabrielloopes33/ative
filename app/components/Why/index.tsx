        ...
        <div id="about">
            ...
            <div className='mx-auto max-w-7xl px-4 my-20 sm:py-20 lg:px-8'>
                <div className='grid grid-cols-1 lg:grid-cols-2'>
                    ...
                    {/* COLUMN-2 */}
                    <div>
                        <h3 className="text-4xl lg:text-5xl pt-4 font-semibold sm:leading-tight mt-5 text-center lg:text-start">Por que escolher a Ative?</h3>
                        <h4 className="text-lg pt-4 font-normal sm:leading-tight text-center text-beach lg:text-start">Não perca tempo com tarefas manuais. Deixe a Ative fazer isso por você. Simplifique fluxos de trabalho, reduza erros e economize tempo.</h4>
